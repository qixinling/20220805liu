		...
		<div class="cardbox">
			<div class="cardcontent">
				<TablePadding :title="title" :list="list" :key="refresh" :ischeckbox="true" :isexcel="false" 
					...
					<!--操作按钮插槽-->
					<div slot="btn_solt">
						<!-- <el-button  type="danger" size="mini" @click="Recovery">恢复交易</el-button> -->
					...
					<el-table-column prop="skdate" label-class-name="skdate" label="收款时间"/>
