<template>
	<div class="slide">
		<PageTitle title="添加幻灯片" :btn="false" :excel="false"></PageTitle>
		<div class="cardbox">
			<div class="cardcontent">
				...
				<el-row class="elrow">
					<el-col :md="6" :sm="24" :span="24" style="margin-bottom: 10px;">
						...
						<el-button type="danger" size="mini" icon="el-icon-back" @click="tolink('Slide')">返回</el-button>
					</el-col>
				</el-row>
			</div>
		</div>
		...
		methods: {
			...
			add: function() {
				...
				_this.$confirm('确定要添加吗?', '提示', {
					...
					_this.$request.post("Api/Slide_Admin/Add", {
						token_admin: _this.$utils.getloc('token_admin'),
						userid_admin: _this.$utils.getloc('userid_admin'),
						lx: _this.lx,
						pagelx: _this.pagelx,
