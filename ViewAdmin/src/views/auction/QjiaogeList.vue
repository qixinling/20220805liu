		...
		<div class="cardbox">
			<div class="cardcontent">
				<TablePadding :title="title" :list="list" :key="refresh" :ischeckbox="true" :isexcel="true" :summary="false"
					...
					<el-table-column prop="odate" label-class-name="odate" label="时间" width="200" fixed></el-table-column>
					...
					<el-table-column prop="sjine" label="金额"></el-table-column>
					<el-table-column prop="zsjine" label="文票积分" width="150">
						<template slot-scope="scope">
							<el-input type="text" v-model="scope.row.zsjine" @change="Updates(scope.row.id,scope.row.zsjine)"></el-input>
						</template>
					</el-table-column>
						<!-- <template slot-scope="scope">
					...
					<el-table-column prop="username" label-class-name="username" label="收货姓名" width="100"></el-table-column>
