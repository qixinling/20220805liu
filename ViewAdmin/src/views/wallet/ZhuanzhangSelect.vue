<template>
	<div class="zhuanzhangselect">
		<PageTitle title="转账管理"></PageTitle>
		<div class="cardbox">
			<div class="cardcontent">
				<div class="addHb">
					<el-dialog title="提示" :visible.sync="addVisible" width="30%" :modal-append-to-body="false">
						...
						<el-row class="el_row">
							...
							<el-col :span="17">
								<el-input-number class="input_number" v-model="shouxu" @change="handleChangeShouxu"
						...
						<el-row class="el_row">
							...
							<el-col :span="17">
								<el-switch v-model="state" active-value="1" inactive-value="0">
								</el-switch>
							</el-col>
						</el-row>
				...
				<TablePadding title="转账管理" :list="list" :key="refresh" :ischeckbox="true" :summary="false"
					ref="tablepadding">
					<!--操作按钮插槽-->
					<div slot="btn_solt">
					...
					<el-table-column prop="jinemin" label="最小转账金额"></el-table-column>
					<el-table-column prop="jinemax" label="最大转账金额"></el-table-column>
					<el-table-column prop="jinebs" label="转账倍数"></el-table-column>
					<el-table-column prop="shouxu" label="转账手续费%"></el-table-column>
					<el-table-column label="团队限制">
	...
	export default {
		...
		methods: {
			...
			Add: function() { // 添加
				...
				this.$request.post(
					"Api/WalletsZhuanzhang_Select_Admin/Add", {
			...
			Delete: function() { // 删除货币
				...
				_this
					...
					.then(() => {
						_this.$request.post(
							"Api/WalletsZhuanzhang_Select_Admin/Delete", {
			...
			handleChangeShouxu: function(value) { // 手续费
				this.shouxu = value;
			},
			...
			Update: function() { // 修改
				this.$request.post(
					"Api/WalletsZhuanzhang_Select_Admin/Update", {
						token_admin: this.$utils.getloc("token_admin"),
						userid_admin: this.$utils.getloc("userid_admin"),
						cid: this.cid,
						jinemax: this.jinemax,
			...
			changeswitch: function(zid) {
				this.$request.post(
					"Api/WalletsZhuanzhang_Select_Admin/IsState", {
						token_admin: this.$utils.getloc("token_admin"),
						userid_admin: this.$utils.getloc("userid_admin"),
						zid: zid
					},
			...
			getdata: function() { // 查询所有数据
				this.$request.post(
					"Api/WalletsZhuanzhang_Select_Admin/List", {
						token_admin: this.$utils.getloc("token_admin"),
						userid_admin: this.$utils.getloc("userid_admin")
					},
					(res) => {
